...
def whatinside(mo, # module, e.g., `import fastcore.all as fa`, use `fa` here=============(0)       
    ...
    'Check what inside a module: `__all__`, functions, classes, builtins, and callables'==(9) # [92;1mhow many items inside mo.__all__?[0m; 
    dun_all = len(mo.__all__) if hasattr(mo, "__all__") else 0============================(10) # [36;1mget all funcs of a module[0m; 
    funcs = inspect.getmembers(mo, inspect.isfunction)====================================(11) # [92;1mget all classes from the module[0m; 
    ...
    if hasattr(mo, "__all__") and dun: ===================================================(21)      
        ...
        for i in mo.__all__:==============================================================(23)      
            ...
            if ismetaclass(obj):==========================================================(25)      
                ...
                kind = "decorator"========================================================(30) # [93;1mget names of all modules of a lib[0m; 
