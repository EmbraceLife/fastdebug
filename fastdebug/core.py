...
# %% auto 0
__all__ = ['defaults', 'pprint', 'inspect', 'dbcolors', 'randomColor', 'colorize', 'strip_ansi', 'printright', 'printsrclinewithidx', 'printsrc', 'dbprintinsert', 'Fastdb', 'randomize_cmtparts_color', 'reliveonce', 'get_exp_data']
...
# %% ../nbs/lib/0002_groundup_matmul.ipynb 22
def get_exp_data():
