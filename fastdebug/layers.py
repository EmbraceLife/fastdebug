# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/lib/src_fastai_001_layers.ipynb.

# %% ../nbs/lib/src_fastai_001_layers.ipynb 2
...
# %% ../nbs/lib/src_fastai_001_layers.ipynb 9
# @snoop
...
# %% ../nbs/lib/src_fastai_001_layers.ipynb 11
...
# %% ../nbs/lib/src_fastai_001_layers.ipynb 18
@module('func')
# @snoop
def Lambda(self, x):
...
# %% ../nbs/lib/src_fastai_001_layers.ipynb 25
...
# %% ../nbs/lib/src_fastai_001_layers.ipynb 31
@module(full=False)
def Flatten(self, x):
...
# %% ../nbs/lib/src_fastai_001_layers.ipynb 35
...
# %% ../nbs/lib/src_fastai_001_layers.ipynb 40
class View(Module):
    "Reshape `x` to `size`"
    def __init__(self, *size): self.size = size
    def forward(self, x): return x.view(self.size)

# %% ../nbs/lib/src_fastai_001_layers.ipynb 44
class ResizeBatch(Module):
    "Reshape `x` to `size`, keeping batch dim the same size"
    def __init__(self, *size): self.size = size
    def forward(self, x): return x.view((x.size(0),) + self.size)

# %% ../nbs/lib/src_fastai_001_layers.ipynb 48
@module()
def Debugger(self,x):
...
# %% ../nbs/lib/src_fastai_001_layers.ipynb 52
def sigmoid_range(x, low, high):
    "Sigmoid function with range `(low, high)`"
    return torch.sigmoid(x) * (high - low) + low

# %% ../nbs/lib/src_fastai_001_layers.ipynb 57
@module('low','high')
def SigmoidRange(self, x):
    "Sigmoid module with range `(low, high)`"
    return sigmoid_range(x, self.low, self.high)

# %% ../nbs/lib/src_fastai_001_layers.ipynb 60
...
# %% ../nbs/lib/src_fastai_001_layers.ipynb 61
...
# %% ../nbs/lib/src_fastai_001_layers.ipynb 64
class PoolType: Avg,Max,Cat = 'Avg','Max','Cat'

# %% ../nbs/lib/src_fastai_001_layers.ipynb 65
...
# %% ../nbs/lib/src_fastai_001_layers.ipynb 66
...
# %% ../nbs/lib/src_fastai_001_layers.ipynb 69
NormType = Enum('NormType', 'Batch BatchZero Weight Spectral Instance InstanceZero')

# %% ../nbs/lib/src_fastai_001_layers.ipynb 70
...
# %% ../nbs/lib/src_fastai_001_layers.ipynb 71
@delegates(nn.BatchNorm2d)
def BatchNorm(nf, ndim=2, norm_type=NormType.Batch, **kwargs):
    "BatchNorm layer with `nf` features and `ndim` initialized depending on `norm_type`."
    return _get_norm('BatchNorm', nf, ndim, zero=norm_type==NormType.BatchZero, **kwargs)

# %% ../nbs/lib/src_fastai_001_layers.ipynb 72
...
# %% ../nbs/lib/src_fastai_001_layers.ipynb 78
...
# %% ../nbs/lib/src_fastai_001_layers.ipynb 80
...
# %% ../nbs/lib/src_fastai_001_layers.ipynb 93
...
# %% ../nbs/lib/src_fastai_001_layers.ipynb 96
...
# %% ../nbs/lib/src_fastai_001_layers.ipynb 112
def AvgPool(ks=2, stride=None, padding=0, ndim=2, ceil_mode=False):
    "nn.AvgPool layer for `ndim`"
    assert 1 <= ndim <= 3
    return getattr(nn, f"AvgPool{ndim}d")(ks, stride=stride, padding=padding, ceil_mode=ceil_mode)

# %% ../nbs/lib/src_fastai_001_layers.ipynb 114
...
# %% ../nbs/lib/src_fastai_001_layers.ipynb 119
...
# %% ../nbs/lib/src_fastai_001_layers.ipynb 128
...
# %% ../nbs/lib/src_fastai_001_layers.ipynb 137
...
# %% ../nbs/lib/src_fastai_001_layers.ipynb 143
def sequential(*args):
...
# %% ../nbs/lib/src_fastai_001_layers.ipynb 146
...
# %% ../nbs/lib/src_fastai_001_layers.ipynb 161
...
# %% ../nbs/lib/src_fastai_001_layers.ipynb 162
...
# %% ../nbs/lib/src_fastai_001_layers.ipynb 167
...
# %% ../nbs/lib/src_fastai_001_layers.ipynb 168
...
# %% ../nbs/lib/src_fastai_001_layers.ipynb 172
...
# %% ../nbs/lib/src_fastai_001_layers.ipynb 193
def swish(x, inplace=False): return _SwishJitAutoFn.apply(x)

# %% ../nbs/lib/src_fastai_001_layers.ipynb 194
class Swish(Module):
    def forward(self, x): return _SwishJitAutoFn.apply(x)

# %% ../nbs/lib/src_fastai_001_layers.ipynb 195
@script
...
# %% ../nbs/lib/src_fastai_001_layers.ipynb 196
...
# %% ../nbs/lib/src_fastai_001_layers.ipynb 198
if ismin_torch('1.9'): Mish = nn.Mish

# %% ../nbs/lib/src_fastai_001_layers.ipynb 199
for o in swish,Swish,mish,Mish: o.__default_init__ = kaiming_uniform_

# %% ../nbs/lib/src_fastai_001_layers.ipynb 202
class ParameterModule(Module):
    "Register a lone parameter `p` in a module."
    def __init__(self, p): self.val = p
    def forward(self, x): return x

# %% ../nbs/lib/src_fastai_001_layers.ipynb 203
...
# %% ../nbs/lib/src_fastai_001_layers.ipynb 205
def has_children(m):
    try: next(m.children())
    except StopIteration: return False
    return True

# %% ../nbs/lib/src_fastai_001_layers.ipynb 207
def flatten_model(m):
