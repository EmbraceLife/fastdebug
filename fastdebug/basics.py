# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/lib/src_fastcore_001_basics.ipynb.
...
# %% ../nbs/lib/src_fastcore_001_basics.ipynb 1
...
# %% ../nbs/lib/src_fastcore_001_basics.ipynb 6
defaults = SimpleNamespace()

# %% ../nbs/lib/src_fastcore_001_basics.ipynb 7
def ifnone(a, b):
    "`b` if `a` is None else `a`"
    return b if a is None else a

# %% ../nbs/lib/src_fastcore_001_basics.ipynb 10
def maybe_attr(o, attr):
    "`getattr(o,attr,o)`"
    return getattr(o,attr,o)

# %% ../nbs/lib/src_fastcore_001_basics.ipynb 13
...
# %% ../nbs/lib/src_fastcore_001_basics.ipynb 19
def is_array(x):
    "`True` if `x` supports `__array__` or `iloc`"
    return hasattr(x,'__array__') or hasattr(x,'iloc')

# %% ../nbs/lib/src_fastcore_001_basics.ipynb 21
...
# %% ../nbs/lib/src_fastcore_001_basics.ipynb 34
def tuplify(o, use_list=False, match=None):
    "Make `o` a tuple"
    return tuple(listify(o, use_list=use_list, match=match))

# %% ../nbs/lib/src_fastcore_001_basics.ipynb 36
def true(x):
    "Test whether `x` is truthy; collections with >0 elements are considered `True`"
    try: return bool(len(x))
    except: return bool(x)

# %% ../nbs/lib/src_fastcore_001_basics.ipynb 38
class NullType:
...
# %% ../nbs/lib/src_fastcore_001_basics.ipynb 40
def tonull(x):
    "Convert `None` to `null`"
    return null if x is None else x

# %% ../nbs/lib/src_fastcore_001_basics.ipynb 42
...
# %% ../nbs/lib/src_fastcore_001_basics.ipynb 46
...
# %% ../nbs/lib/src_fastcore_001_basics.ipynb 51
...
# %% ../nbs/lib/src_fastcore_001_basics.ipynb 53
class ignore_exceptions:
    "Context manager to ignore exceptions"
    def __enter__(self): pass
    def __exit__(self, *args): return True

# %% ../nbs/lib/src_fastcore_001_basics.ipynb 56
...
# %% ../nbs/lib/src_fastcore_001_basics.ipynb 58
...
# %% ../nbs/lib/src_fastcore_001_basics.ipynb 70
class _InfMeta(type):
    @property
...
# %% ../nbs/lib/src_fastcore_001_basics.ipynb 71
class Inf(metaclass=_InfMeta):
    "Infinite lists"
    pass

# %% ../nbs/lib/src_fastcore_001_basics.ipynb 76
_dumobj = object()
...
# %% ../nbs/lib/src_fastcore_001_basics.ipynb 77
def in_(x, a):
    "`True` if `x in a`"
    return x in a
...
# %% ../nbs/lib/src_fastcore_001_basics.ipynb 94
def otherwise(x, tst, y):
    "`y if tst(x) else x`"
    return y if tst(x) else x

# %% ../nbs/lib/src_fastcore_001_basics.ipynb 98
def custom_dir(c, add):
    "Implement custom `__dir__`, adding `add` to `cls`"
    return object.__dir__(c) + listify(add)

# %% ../nbs/lib/src_fastcore_001_basics.ipynb 101
class AttrDict(dict):
...
# %% ../nbs/lib/src_fastcore_001_basics.ipynb 105
...
# %% ../nbs/lib/src_fastcore_001_basics.ipynb 107
...
# %% ../nbs/lib/src_fastcore_001_basics.ipynb 112
...
# %% ../nbs/lib/src_fastcore_001_basics.ipynb 119
def annotations(o):
...
# %% ../nbs/lib/src_fastcore_001_basics.ipynb 122
def anno_ret(func):
    "Get the return annotation of `func`"
    return annotations(func).get('return', None) if func else None

# %% ../nbs/lib/src_fastcore_001_basics.ipynb 128
...
# %% ../nbs/lib/src_fastcore_001_basics.ipynb 129
def union2tuple(t):
    if (getattr(t, '__origin__', None) is Union
        or (UnionType and isinstance(t, UnionType))): return t.__args__
    return t

# %% ../nbs/lib/src_fastcore_001_basics.ipynb 131
...
# %% ../nbs/lib/src_fastcore_001_basics.ipynb 133
def with_cast(f):
...
# %% ../nbs/lib/src_fastcore_001_basics.ipynb 135
...
# %% ../nbs/lib/src_fastcore_001_basics.ipynb 136
...
# %% ../nbs/lib/src_fastcore_001_basics.ipynb 188
...
# %% ../nbs/lib/src_fastcore_001_basics.ipynb 191
class GetAttrBase:
...
# %% ../nbs/lib/src_fastcore_001_basics.ipynb 192
class GetAttr:
...
# %% ../nbs/lib/src_fastcore_001_basics.ipynb 212
...
# %% ../nbs/lib/src_fastcore_001_basics.ipynb 218
class ShowPrint:
    "Base class that prints for `show`"
    def show(self, *args, **kwargs): print(str(self))

# %% ../nbs/lib/src_fastcore_001_basics.ipynb 220
class Int(int,ShowPrint):
    "An extensible `int`"
    pass

# %% ../nbs/lib/src_fastcore_001_basics.ipynb 221
...
# %% ../nbs/lib/src_fastcore_001_basics.ipynb 225
def flatten(o):
...
# %% ../nbs/lib/src_fastcore_001_basics.ipynb 259
def not_(f):
    "Create new function that negates result of `f`"
    def _f(*args, **kwargs): return not f(*args, **kwargs)
    return _f

# %% ../nbs/lib/src_fastcore_001_basics.ipynb 261
...
# %% ../nbs/lib/src_fastcore_001_basics.ipynb 262
...
# %% ../nbs/lib/src_fastcore_001_basics.ipynb 263
...
# %% ../nbs/lib/src_fastcore_001_basics.ipynb 269
def only(o):
...
# %% ../nbs/lib/src_fastcore_001_basics.ipynb 271
...
# %% ../nbs/lib/src_fastcore_001_basics.ipynb 273
...
# %% ../nbs/lib/src_fastcore_001_basics.ipynb 280
...
# %% ../nbs/lib/src_fastcore_001_basics.ipynb 282
def set_nested_idx(coll, value, *idxs):
    "Set value indexed like `nested_idx"
    coll,idx = _nested_idx(coll, *idxs)
    coll[idx] = value

# %% ../nbs/lib/src_fastcore_001_basics.ipynb 284
def val2idx(x):
    "Dict from value to index"
    return {v:k for k,v in enumerate(x)}

# %% ../nbs/lib/src_fastcore_001_basics.ipynb 286
...
# %% ../nbs/lib/src_fastcore_001_basics.ipynb 288
...
# %% ../nbs/lib/src_fastcore_001_basics.ipynb 297
...
# %% ../nbs/lib/src_fastcore_001_basics.ipynb 315
class _Arg:
...
# %% ../nbs/lib/src_fastcore_001_basics.ipynb 316
class bind:
...
# %% ../nbs/lib/src_fastcore_001_basics.ipynb 328
def mapt(func, *iterables):
    "Tuplified `map`"
    return tuple(map(func, *iterables))

# %% ../nbs/lib/src_fastcore_001_basics.ipynb 330
...
# %% ../nbs/lib/src_fastcore_001_basics.ipynb 338
...
# %% ../nbs/lib/src_fastcore_001_basics.ipynb 340
...
# %% ../nbs/lib/src_fastcore_001_basics.ipynb 342
...
# %% ../nbs/lib/src_fastcore_001_basics.ipynb 346
def instantiate(t):
    "Instantiate `t` if it's a type, otherwise do nothing"
    return t() if isinstance(t, type) else t

# %% ../nbs/lib/src_fastcore_001_basics.ipynb 348
def _using_attr(f, attr, x): return f(getattr(x,attr))

# %% ../nbs/lib/src_fastcore_001_basics.ipynb 349
def using_attr(f, attr):
    "Construct a function which applies `f` to the argument's attribute `attr`"
    return partial(_using_attr, f, attr)

# %% ../nbs/lib/src_fastcore_001_basics.ipynb 353
class _Self:
...
# %% ../nbs/lib/src_fastcore_001_basics.ipynb 354
class _SelfCls:
...
# %% ../nbs/lib/src_fastcore_001_basics.ipynb 355
_all_ = ['Self']

# %% ../nbs/lib/src_fastcore_001_basics.ipynb 361
def copy_func(f):
...
# %% ../nbs/lib/src_fastcore_001_basics.ipynb 368
...
# %% ../nbs/lib/src_fastcore_001_basics.ipynb 379
...
# %% ../nbs/lib/src_fastcore_001_basics.ipynb 387
...
# %% ../nbs/lib/src_fastcore_001_basics.ipynb 389
def compile_re(pat):
    "Compile `pat` if it's not None"
    return None if pat is None else re.compile(pat)

# %% ../nbs/lib/src_fastcore_001_basics.ipynb 391
...
# %% ../nbs/lib/src_fastcore_001_basics.ipynb 404
class PrettyString(str):
    "Little hack to get strings to show properly in Jupyter."
    def __repr__(self): return self

# %% ../nbs/lib/src_fastcore_001_basics.ipynb 410
...
# %% ../nbs/lib/src_fastcore_001_basics.ipynb 412
def num_cpus():
    "Get number of cpus"
...
# %% ../nbs/lib/src_fastcore_001_basics.ipynb 414
...
# %% ../nbs/lib/src_fastcore_001_basics.ipynb 417
def _typeerr(arg, val, typ): return TypeError(f"{arg}=={val} not {typ}")

# %% ../nbs/lib/src_fastcore_001_basics.ipynb 418
def typed(f):
...
# %% ../nbs/lib/src_fastcore_001_basics.ipynb 426
def exec_new(code):
