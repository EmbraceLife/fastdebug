...
# %% ../nbs/lib/src_fastai_001_layers.ipynb 16
@module('func')
# @snoop
def Lambda(self, x):
...
# %% ../nbs/lib/src_fastai_001_layers.ipynb 23
...
# %% ../nbs/lib/src_fastai_001_layers.ipynb 29
@module(full=False)
# @snoop
def Flatten(self, x):
...
# %% ../nbs/lib/src_fastai_001_layers.ipynb 33
...
# %% ../nbs/lib/src_fastai_001_layers.ipynb 38
class View(Module):
    "Reshape `x` to `size`"
    def __init__(self, *size): self.size = size
    def forward(self, x): return x.view(self.size)

# %% ../nbs/lib/src_fastai_001_layers.ipynb 42
class ResizeBatch(Module):
    "Reshape `x` to `size`, keeping batch dim the same size"
    def __init__(self, *size): self.size = size
    def forward(self, x): return x.view((x.size(0),) + self.size)

# %% ../nbs/lib/src_fastai_001_layers.ipynb 46
@module()
def Debugger(self,x):
...
# %% ../nbs/lib/src_fastai_001_layers.ipynb 50
def sigmoid_range(x, low, high):
    "Sigmoid function with range `(low, high)`"
    return torch.sigmoid(x) * (high - low) + low

# %% ../nbs/lib/src_fastai_001_layers.ipynb 54
@module('low','high')
def SigmoidRange(self, x):
    "Sigmoid module with range `(low, high)`"
    return sigmoid_range(x, self.low, self.high)

# %% ../nbs/lib/src_fastai_001_layers.ipynb 59
...
# %% ../nbs/lib/src_fastai_001_layers.ipynb 75
class PoolType: Avg,Max,Cat = 'Avg','Max','Cat'

# %% ../nbs/lib/src_fastai_001_layers.ipynb 77
...
# %% ../nbs/lib/src_fastai_001_layers.ipynb 83
...
# %% ../nbs/lib/src_fastai_001_layers.ipynb 323
# @snoop
...
# %% ../nbs/lib/src_fastai_001_layers.ipynb 333
class NoneReduce():
...
# %% ../nbs/lib/src_fastai_001_layers.ipynb 339
# @snoop
def in_channels(m):
