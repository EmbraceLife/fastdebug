...
# %% auto 0
__all__ = ['test', 'test_eq', 'match_pct', 'search_data_url', 'check_data_directories', 'get_img_paths', 'get_labels', 'mean_std', 'normalize', 'imgs2tensor', 'get_exp_data', 'chunks', 'chunks_faster', 'Matrix', 'rand', 'matmul_3loops', 'dot', 'matmul_2loops_njit', 'matmul_2loops_elementwise', 'matmul_2loops_dotproduct', 'matmul_1loop_broadcast', 'matmul_einsum_noloop', 'lin', 'relu', 'print_derivaties']
...
# %% ../nbs/lib/groundup_005_forward_backward_passes.ipynb 28
def lin(x, w, b): 
    "build a single layer linear model. use torch.matmul (faster version of einsum) to create a linear model"
    return x@w + b

# %% ../nbs/lib/groundup_005_forward_backward_passes.ipynb 33
def relu(x): 
    "basic relu with max in torch"
    return x.clamp_min(0.)

# %% ../nbs/lib/groundup_005_forward_backward_passes.ipynb 60
