# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/lib/src_fastcore_002_foundation.ipynb.
...
# %% ../nbs/lib/src_fastcore_002_foundation.ipynb 1
...
# %% ../nbs/lib/src_fastcore_002_foundation.ipynb 5
@contextmanager
...
# %% ../nbs/lib/src_fastcore_002_foundation.ipynb 6
...
# %% ../nbs/lib/src_fastcore_002_foundation.ipynb 16
def docs(cls):
    "Decorator version of `add_docs`, using `_docs` dict"
    add_docs(cls, **cls._docs)
    return cls

# %% ../nbs/lib/src_fastcore_002_foundation.ipynb 23
def coll_repr(c, max_n=10):
    "String repr of up to `max_n` items of (possibly lazy) collection `c`"
    return f'(#{len(c)}) [' + ','.join(itertools.islice(map(repr,c), max_n)) + (
        '...' if len(c)>max_n else '') + ']'

# %% ../nbs/lib/src_fastcore_002_foundation.ipynb 28
def is_bool(x):
    "Check whether `x` is a bool or None"
    return isinstance(x,(bool,NoneType)) or risinstance('bool_', x)

# %% ../nbs/lib/src_fastcore_002_foundation.ipynb 29
def mask2idxs(mask):
...
# %% ../nbs/lib/src_fastcore_002_foundation.ipynb 31
def cycle(o):
    "Like `itertools.cycle` except creates list of `None`s if `o` is empty"
    o = listify(o)
    return itertools.cycle(o) if o is not None and len(o) > 0 else itertools.cycle([None])

# %% ../nbs/lib/src_fastcore_002_foundation.ipynb 33
def zip_cycle(x, *args):
    "Like `itertools.zip_longest` but `cycle`s through elements of all but first argument"
    return zip(x, *map(cycle,args))

# %% ../nbs/lib/src_fastcore_002_foundation.ipynb 35
def is_indexer(idx):
    "Test whether `idx` will index a single item in a list"
    return isinstance(idx,int) or not getattr(idx,'ndim',1)

# %% ../nbs/lib/src_fastcore_002_foundation.ipynb 41
class CollBase:
...
# %% ../nbs/lib/src_fastcore_002_foundation.ipynb 45
class _L_Meta(type):
    def __call__(cls, x=None, *args, **kwargs):
        if not args and not kwargs and x is not None and isinstance(x,cls): return x
        return super().__call__(x, *args, **kwargs)

# %% ../nbs/lib/src_fastcore_002_foundation.ipynb 46
...
# %% ../nbs/lib/src_fastcore_002_foundation.ipynb 47
add_docs(L,
...
# %% ../nbs/lib/src_fastcore_002_foundation.ipynb 48
...
# %% ../nbs/lib/src_fastcore_002_foundation.ipynb 49
Sequence.register(L);

# %% ../nbs/lib/src_fastcore_002_foundation.ipynb 129
...
# %% ../nbs/lib/src_fastcore_002_foundation.ipynb 130
def read_config_file(file, **kwargs):
    config = ConfigParser(**kwargs)
    config.read(file, encoding='utf8')
    return config['DEFAULT']

# %% ../nbs/lib/src_fastcore_002_foundation.ipynb 133
class Config:
