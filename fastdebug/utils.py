...
# %% auto 0
__all__ = ['expand', 'test_eq', 'test_is', 'FunctionType', 'MethodType', 'nb_url', 'nb_path', 'nb_name', 'ipy2md', 'expandcell',
           'inspect_class', 'ismetaclass', 'isdecorator', 'whatinside', 'whichversion', 'fastview', 'fastsrcs',
           'getrootport', 'jn_link', 'get_all_nbs', 'openNB', 'highlight', 'display_md', 'display_block', 'fastnbs',
           'fastcodes', 'fastnotes', 'fastlistnbs', 'fastlistsrcs']
...
# %% ../nbs/lib/utils.ipynb 72
import os

# %% ../nbs/lib/utils.ipynb 76
def fastsrcs():
