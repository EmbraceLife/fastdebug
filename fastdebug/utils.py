...
# %% auto 0
__all__ = ['test_eq', 'test_is', 'FunctionType', 'MethodType', 'kagglenbs', 'nb_url', 'nb_path', 'nb_name', 'ipy2md', 'inspect_class', 'ismetaclass', 'isdecorator', 'whatinside', 'whichversion', 'fastview', 'fastsrcs', 'get_all_nbs', 'openNB', 'openNBKaggle', 'fastnbs', 'fastcodes', 'fastnotes', 'fastlistnbs', 'fastlistsrcs', 'get_exp_data', 'idx_line', 'check']
...
# %% ../nbs/lib/0002_groundup_matmul.ipynb 23
def get_exp_data():
...
# %% ../nbs/lib/0001_groundup_get_data_ready.ipynb 74
def idx_line(lst):
    "return zip(range(len(lst)), lst)"
    return zip(range(len(lst)), lst)

# %% ../nbs/lib/0001_groundup_get_data_ready.ipynb 75
