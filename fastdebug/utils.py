...
# %% auto 0
__all__ = ['doc', 'op', 'ic', 'snoop', 'pp', 'snoopon', 'test_eq', 'test_is', 'FunctionType', 'MethodType', 'kagglenbs', 'plot_func', 'plot_funcs', 'plot_fns', 'type_watch', 'sig_watch', 'view', 'stats_watch', 'snoop_onoff', 'nb_url', 'nb_path', 'nb_name', 'ipy2md', 'automagics', 'inspect_class', 'ismetaclass', 'isdecorator', 'whatinside', 'whichversion', 'fastview', 'fastsrcs', 'get_all_nbs', 'openNB', 'openNBKaggle', 'fastnbs', 'fastcodes', 'fastnotes', 'fastlistnbs', 'fastlistsrcs', 'idx_line', 'check']
...
# %% ../nbs/lib/01_utils.ipynb 143
from pathlib import *

# %% ../nbs/lib/01_utils.ipynb 147
def get_all_nbs():
