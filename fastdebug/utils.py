...
# %% auto 0
__all__ = ['multioutput', 'expand', 'test_eq', 'test_is', 'FunctionType', 'MethodType', 'kagglenbs', 'multi_output', 'nb_url', 'nb_path', 'nb_name', 'ipy2md', 'autoreload', 'expandcell', 'inspect_class', 'ismetaclass', 'isdecorator', 'whatinside', 'whichversion', 'fastview', 'fastsrcs', 'getrootport', 'jn_link', 'get_all_nbs', 'openNB', 'openNBKaggle', 'highlight', 'display_md', 'display_block', 'fastnbs', 'fastcodes', 'fastnotes', 'fastlistnbs', 'fastlistsrcs', 'idx_line', 'check']
...
# %% ../nbs/lib/utils.ipynb 33
FunctionType = FunctionType
MethodType = MethodType

# %% ../nbs/lib/utils.ipynb 38
...
# %% ../nbs/lib/utils.ipynb 77
import os

# %% ../nbs/lib/utils.ipynb 81
def fastsrcs():
...
# %% ../nbs/lib/fastai_from_scratch/0001_fastscratch_matmul.ipynb 34
def idx_line(lst):
    "return zip(range(len(lst)), lst)"
    return zip(range(len(lst)), lst)

# %% ../nbs/lib/fastai_from_scratch/0001_fastscratch_matmul.ipynb 35
def check(f, # function name, like PIL.Image.open
        n=10 # num of lines to print
       ): 
    "check any object on its signature, class, __repr__, docs, __dict__, and other checks borrowed from utils"
    if callable(f) or hasattr(f, '__signature__'):
